	...
	if( ((motor->getFacade())->_couleur1!=0 && (motor->getFacade())->_couleur2!=0) &&
		...
		(motor->getNbJoueurs()==2)){ //ON EST DANS LE CAS OU L'ON A DEUX JOUEURS
			motor->getJoueurInd(0) = (*new Joueur(1, 
													...
													(CasePort*) motor->getPlateau()->getCasePort(motor->getFacade()->_couleur3))); cout<<"Joueur1 initialisé"<<endl;
			motor->getJoueurInd(1) = (*new Joueur(2, 
													(CasePort*) motor->getPlateau()->getCasePort(motor->getFacade()->_couleur2),
													(CasePort*) motor->getPlateau()->getCasePort(motor->getFacade()->_couleur4))); cout<<"Joueur2 initialisé"<<endl;
			...
			motor->getJoueurInd(0) = (*new Joueur(1, (CasePort*) motor->getPlateau()->getCasePort(motor->getFacade()->_couleur1))); cout<<"Joueur1 initialisé"<<endl;
			motor->getJoueurInd(1) = (*new Joueur(2, (CasePort*) motor->getPlateau()->getCasePort(motor->getFacade()->_couleur2))); cout<<"Joueur2 initialisé"<<endl;
			motor->getJoueurInd(2) = (*new Joueur(3, (CasePort*) motor->getPlateau()->getCasePort(motor->getFacade()->_couleur3))); cout<<"Joueur3 initialisé"<<endl;
			motor->modifCourant(ATTENTEPREMLANCERDE);
			...
			motor->getJoueurInd(1) = (*new Joueur(2, (CasePort*) motor->getPlateau()->getCasePort(motor->getFacade()->_couleur2)));cout<<"Joueur2 initialisé"<<endl;
			motor->getJoueurInd(2) = (*new Joueur(3, (CasePort*) motor->getPlateau()->getCasePort(motor->getFacade()->_couleur3)));cout<<"Joueur3 initialisé"<<endl;
			motor->getJoueurInd(3) = (*new Joueur(4, (CasePort*) motor->getPlateau()->getCasePort(motor->getFacade()->_couleur4)));cout<<"Joueur4 initialisé"<<endl;
			motor->modifCourant(ATTENTEPREMLANCERDE);
