...
AppWizard a créé cette DLL ProjetTest pour vous.

Ce fichier contient un résumé des éléments contenus dans chaque fichier qui
constitue votre application ProjetTest.
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH) nommé ProjetTest.pch et un fichier de types précompilés 
    nommé StdAfx.obj.
