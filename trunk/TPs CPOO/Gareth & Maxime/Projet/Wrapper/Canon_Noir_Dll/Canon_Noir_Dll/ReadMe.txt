========================================================================
    BIBLIOTHÈQUE MFC (MICROSOFT FOUNDATION CLASS) : Vue d'ensemble du 
    projet Canon_Noir_Dll
========================================================================


AppWizard a créé cette DLL Canon_Noir_Dll pour vous. Cette DLL décrit
non seulement les bases de l'utilisation de Microsoft Foundation Classes, mais
est également un point de départ pour l'écriture de votre DLL.

Ce fichier contient un résumé des éléments contenus dans chaque fichier qui
constitue votre DLL Canon_Noir_Dll.

Canon_Noir_Dll.vcxproj
...
Canon_Noir_Dll.vcxproj.filters
...
Canon_Noir_Dll.h
    Il s'agit du fichier d'en-tête principal pour la DLL. Il déclare la classe
    CCanon_Noir_DllApp.

Canon_Noir_Dll.cpp
    Il s'agit du fichier source principal de la DLL. Il contient la classe 
    CCanon_Noir_DllApp.
...
Canon_Noir_Dll.def
    Ce fichier contient des informations sur la DLL qui doivent être
    fournies pour qu'elle s'exécute avec Microsoft Windows. Il définit les 
    paramètres tels que le nom et la description de la DLL. Il exporte également
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH) nommé Canon_Noir_Dll.pch et un fichier de types précompilés 
    nommé StdAfx.obj.
