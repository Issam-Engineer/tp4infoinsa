...
public:
	...
	*
	* \param[in] c reference on a constant string
	* \return a reference on the current string
	*/
	...
	*
	* \param[in] c reference on a constant string
	* \return a reference on the current concatenated string
	*/
	Chaine& operator+= (const Chaine& c);

	/**
	* \fn ~Chaine();
	* \brief String destructor with one paremeter (char* type)
	*
	* \param[in] c Pointer on a constant char
	*/
	~Chaine();
	...
	*/
	...
	/**
	* \fn ~Chaine(const Chaine & c){;
	* \brief String destructor with one paremeter (string type)
	*
	* \param[in] c Reference on a constant string
	*/
    ~Chaine(const Chaine & c){
